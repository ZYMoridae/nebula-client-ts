...
const ActionType = {
  ...
  RECEIEVE_ORDER: 'RECEIEVE_ORDER',
  FETCHING_ORDER_PENDING: 'FETCHING_ORDER_PENDING',
  FETCHING_ORDER_REJECTED: 'FETCHING_ORDER_REJECTED',

  REDIRECT_TO_PAYMENT_SUCCESS: 'REDIRECT_TO_PAYMENT_SUCCESS',

  USER_PREFERENCE: {
    ADD_USER_SHIPPING_PREFERENCE_FULLFILLED: 'ADD_USER_SHIPPING_PREFERENCE_FULLFILLED',
    ADD_USER_SHIPPING_PREFERENCE_PENDING: 'ADD_USER_SHIPPING_PREFERENCE_PENDING',
    ADD_USER_SHIPPING_PREFERENCE_REJECTED: 'ADD_USER_SHIPPING_PREFERENCE_REJECTED'
  },

  ORDER: {
    RECEIEVE_USER_ORDERS: 'RECEIEVE_USER_ORDERS',
    FETCHING_USER_ORDERS_PENDING: 'FETCHING_USER_ORDERS_PENDING',
    FETCHING_USER_ORDERS_REJECTED: 'FETCHING_USER_ORDERS_REJECTED'
  },

  RECEIVE_USER: 'RECEIVE_USER',
  CREATING_USERS_PENDING: 'CREATING_USERS_PENDING',
  CREATING_USERS_REJECTED: 'CREATING_USERS_REJECTED'
