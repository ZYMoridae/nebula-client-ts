...
const ActionType = {
  ...
  USER_PREFERENCE: {
    ADD_USER_SHIPPING_PREFERENCE_FULLFILLED:
      "ADD_USER_SHIPPING_PREFERENCE_FULLFILLED",
    ADD_USER_SHIPPING_PREFERENCE_PENDING:
      "ADD_USER_SHIPPING_PREFERENCE_PENDING",
    ADD_USER_SHIPPING_PREFERENCE_REJECTED:
      "ADD_USER_SHIPPING_PREFERENCE_REJECTED"
  },
  ...
  TEACHER: {
    ...
    GET: {
      ERROR: "TEACHER_GET_ERROR",
      PENDING: "TEACHER_GET_PENDING",
      FULFILLED: "TEACHER_GET_FULFILLED"
    }
  }
};
