...
class PaymentOrder extends React.Component<MyProps, MyState> {

  calculateTotalAmount(orderItems: any) {
    return orderItems.map((orderItem: any) => orderItem.quantity * orderItem.product.price)
      ...
      <div>
        <Paper className={classes.paymentOrderContainer}>
          ...
          <Table className={classes.table}>
            ...
            <TableBody>
              {activateOrder && activateOrder.orderItems.map((orderItem: any, index: number) =>
                <TableRow key={index}>
