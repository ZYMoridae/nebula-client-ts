...
const calculateItemPrice = (
  ...
  if (!process.env.NODE_ENV || process.env.NODE_ENV === "development") {
    console.log(
      `Product [${product.id}] quantity has been changed to [${userSelectedQuantity}]`
    );
  }
...
class ShoppingCart extends React.Component<MyProps, MyState> {
  ...
  render() {
      ...
      info.forEach((cartItem: any, index: number) => {
        if (this.state.itemCheckedState[index]) {
          let checkoutItem = {
            ...
            quantity:
              this.state.itemQuantity[index] == undefined
                ? cartItem.quantity
                : this.state.itemQuantity[index],
    ...
    const getTotalItemCount = () => {
      return this.state.itemCheckedState.filter((item: any) => item == true)
        .length;
    };
      ...
      <div className={classes.root}>
        <Grid container>
          ...
          <Grid item xs={12} sm={8}>
            {isFetchingShoppingCart &&
              renderLoadingIndicator(isFetchedShoppingCart)}
              ...
              <Fade in={true} timeout={1000}>
                <div>
                          ...
                          <TableRow key={row.id}>
                            <TableCell component="th" scope="row">
                              <Typography variant="h6" gutterBottom>
                                <a
                                  className={classes.shoppingItemName}
                            ...
                            <TableCell align="right">
                              <Checkbox
                                checked={
                                  this.state.itemCheckedState[index] || false
                                }
                  ...
                  <Typography
                    ...
                    gutterBottom
                    align="right"
                    className={classes.checkoutBlock}
                  >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <Button
                      ...
                      disabled={isCreatingOrder ? true : false}
                    >
                      Proceed to Checkout
                    </Button>
                  </div>
