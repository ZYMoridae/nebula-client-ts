...
const renderProductMetas = (productMetas: any, theme: any, classes: any) => {
  ...
  if (productMetas == undefined || !Array.isArray(productMetas)) {
    ...
    block = (
      <ContentNotFound
        warningText="Product metas was unavailable!"
        paddingTop={theme.spacing(5)}
  ...
  return (
    <Grid
      ...
      xs={12}
      sm={isDataValid ? 6 : 12}
      className={classes.productMetasContainer}
    >
...
const renderCustomerReviews = (
  ...
  if (
    ...
    block = (
      <ContentNotFound
        warningText="No customer reviews!"
        paddingTop={theme.spacing(5)}
        paddingBottom={theme.spacing(5)}
      />
    );
...
class ProductInfo extends React.Component<MyProps, MyState> {
  ...
  componentDidMount() {
    ...
    this.setState({
      labelWidth: (ReactDOM.findDOMNode(this.InputLabelRef) as HTMLInputElement)
        .offsetWidth
    });
  ...
  render() {
    ...
    if (
      info.unitsInStock != undefined &&
      info.unitsInStock > 0 &&
      info.unitsInStock < 20
    ) {
    ...
    const itemSkuChangeHandler = (event: any) => {
      this.setState({
    ...
    const images = [
      {
        original:
          "https://upserve.com/media/sites/2/Ledger-Restaurant-Bar-brunch_Photo-courtesy-of-Ledger-1024x768.jpg",
        thumbnail:
          "https://upserve.com/media/sites/2/Ledger-Restaurant-Bar-brunch_Photo-courtesy-of-Ledger-1024x768.jpg"
      },
      {
        original:
          "http://www.fabfoodchicago.com/wp-content/uploads/2017/05/IMG_4980-1024x768.jpg",
        thumbnail:
          "http://www.fabfoodchicago.com/wp-content/uploads/2017/05/IMG_4980-1024x768.jpg"
      },
      {
        original:
          "http://www.hofbrauhaus.com.au/wp-content/uploads/2019/03/Farmer-Breakfast-1024x768.jpg",
        thumbnail:
          "http://www.hofbrauhaus.com.au/wp-content/uploads/2019/03/Farmer-Breakfast-1024x768.jpg"
      },
      {
    ...
    if (fetchProductInfoError != undefined) {
      ...
      productInfoBlock = (
        <div>
                    ...
                    <div>
                      ...
                      {/* {Array.isArray(info.skus) && (
                        ...
                        >
                          ...
                          >
                            {info.skus.map((item: any, index: number) => (
                              <MenuItem key={index} value={item.skuCode}>
                                {item}
                              </MenuItem>
                            ))}
                          </Select>
          ...
          {info.productMetas &&
            renderProductMetas(info.productMetas, theme, classes)}
          {/* <Divider className={classes.divider} /> */}
